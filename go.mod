module github.com/getlantern/autoupdate-server
...
require (
	...
	github.com/getlantern/telemetry v0.0.0-20220608110433-737cb535c0c1
...
require (
	...
	gopkg.in/DataDog/dd-trace-go.v1 v1.49.0 // indirect
